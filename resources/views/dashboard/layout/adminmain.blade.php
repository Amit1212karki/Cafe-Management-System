        ...
        <div class="main-menu">
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a href="/admin-manager-index" class="menu-link waves-effect">
                    ...
                    <li class="menu-item">
                        <a href="/add-admin-point" class="menu-link waves-effect">
                            <span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" data-lucide="calendar"
                                    class="lucide lucide-calendar">
                    ...
                    <li class="menu-item">
                        <a href="/admin/change-password" class="menu-link waves-effect">
                            <span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" data-lucide="calendar"
                                    class="lucide lucide-calendar">
