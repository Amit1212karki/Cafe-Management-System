                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right flex gap-4">
                                ...
                                <a href="/admin/change-password/{{ $user->id }}" class="font-medium text-blue-600 hover:underline">
                                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v-3m0-3h.01M17 11V7a5 5 0 0 0-10 0v4m13 0H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2Z" />
                                    </svg>
                                </a>
